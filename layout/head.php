...
<body>
    ...
    <header id="header" class="fixed-top">
        ...
        <div class="container d-flex align-items-center h-50 d-inline-block">

            <a href="index.php" class="logo mr-auto"><img src="./assets/img/logo.png" alt="" style="width: 140px;"></a>
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    <li class="active"><a href="list_bisnis.php">List Bisnis</a></li>
      ...
      <ul>
        ...
        <li><a href="#">Drop Down 4</a></li>
            ...
            <a href="login.php" class="appointment-btn scrollto">MASUK</a>
